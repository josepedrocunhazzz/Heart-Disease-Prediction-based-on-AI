...
```text
HeartDisease_AI/
├── Projeto_*.ipynb           # notebook principal da experiência
...
Trabalho desenvolvido no âmbito da unidade curricular de Inteligência Artificial Centrada no Humano da Universidade de Coimbra.
